...
public class RedisShopReservationLimiter implements ShopReservationLimiter {

    private static final Duration DEFAULT_TTL = Duration.ofSeconds(60);

    private static final Logger log = LoggerFactory.getLogger(RedisShopReservationLimiter.class);
