...
public final class EconomyWebMapper {
    ...
    public static EconomyResponse.Trade toResponse(EconomyResult.TradeSummary trade) {
    ...
    public static EconomyResponse.Trades toResponse(EconomyResult.Trades trades) {
        return new EconomyResponse.Trades(trades.trades().stream().map(EconomyWebMapper::toResponse).toList());
    }

    public static EconomyResponse.TradeSummary toResponse(EconomyResult.TradeSummary summary) {
