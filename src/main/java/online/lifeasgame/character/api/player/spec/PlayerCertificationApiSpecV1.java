...
public interface PlayerCertificationApiSpecV1 {
    ...
    ResponseEntity<ApiResponse<PlayerCertificationResponse.Created>> createPlayerCertification(
    ...
    ResponseEntity<ApiResponse<PlayerCertificationResponse.Changed>> updatePlayerCertification(
            @PathVariable Long certificationId,
